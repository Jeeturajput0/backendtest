import { C as setInnerHTML, S as setCSSProperty, _ as getTranslate, a as elementIndex, b as nextTick, c as elementOffset, g as getSlideTransformEl, h as getRotateFix, i as elementChildren, l as elementOuterSize, n as createElement, p as elementTransitionEnd, t as classesToTokens, u as elementParents, v as isObject, x as now, y as makeElementsArray } from "./utils-Dd8GX6FD.js";
...
var EffectCube = ({ swiper, extendParams, on }) => {
	...
	const recreateShadows = () => {
		...
		swiper.slides.forEach((slideEl) => {
			createSlideShadows(slideEl, Math.max(Math.min(slideEl.progress ?? 0, 1), -1), isHorizontal);
		});
	};
	const setTranslate = () => {
