        ...
        {mobileOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed inset-y-0 left-0 z-[60] w-[280px] overflow-y-auto bg-slate-950 shadow-2xl lg:hidden"
            >
              <button
                onClick={() => setMobileOpen(false)}
                className="absolute right-4 top-4 rounded-xl p-2 text-slate-400 hover:bg-white/10 hover:text-white"
              >
                <X size={19} />
              </button>
