...
export default function App() {
  return <Routes>
    ...
    <Route path="/" element={<Layout />}>
      ...
      <Route path="shop" element={<Shop />} /><Route path="about" element={<About />} />
      <Route path="cart" element={<Cart />} /><Route path="checkout" element={<Checkout />} />
      <Route path="order-success" element={<OrderSuccess />} /><Route path="my-orders" element={<MyOrders />} />
      <Route path="product/:product_id" element={<ProductDetails />} />
    </Route>
    <Route path="/admin" element={<RequireAuth><AdminLayout /></RequireAuth>}>
      <Route index element={<Navigate to="dashboard" replace />} /><Route path="dashboard" element={<Dashboard />} />
      <Route path="products" element={<Products />} /><Route path="products/add" element={<AddProduct />} /><Route path="products/edit/:product_id" element={<AddProduct />} />
      <Route path="orders" element={<Orders />} /><Route path="orders/add" element={<AddOrders />} />
      <Route path="categories" element={<Category />} /><Route path="categories/add" element={<AddCategory />} /><Route path="categories/edit/:category_id" element={<AddCategory />} />
      <Route path="brand" element={<Brand />} /><Route path="brand/add" element={<AddBrand />} /><Route path="brand/edit/:brand_id" element={<AddBrand />} />
      <Route path="colors" element={<Color />} /><Route path="colors/add" element={<AddColor />} />
      <Route path="sizes" element={<Sizes />} /><Route path="sizes/add" element={<AddSize />} /><Route path="sizes/edit/:sizes_id" element={<AddSize />} />
      <Route path="coupons" element={<Coupon />} /><Route path="coupons/add" element={<AddCoupon />} /><Route path="coupons/edit/:coupon_id" element={<AddCoupon />} />
      <Route path="offers" element={<Offer />} /><Route path="offers/add" element={<AddOffer />} /><Route path="offers/edit/:offer_id" element={<AddOffer />} />
      <Route path="banners" element={<Banners />} /><Route path="banners/add" element={<AddBanner />} /><Route path="banners/edit/:id" element={<AddBanner />} />
      <Route path="reviews" element={<Reviews />} /><Route path="reviews/add" element={<AddReview />} />
      <Route path="payments" element={<Payments />} /><Route path="payments/add" element={<AddPayment />} />
      <Route path="profile" element={<Profile />} /><Route path="settings" element={<Settings />} /><Route path="users" element={<Users />} />
    </Route>
    <Route path="*" element={<Navigate to={localStorage.getItem("token") ? "/admin" : "/login"} replace />} />
  </Routes>;
}
